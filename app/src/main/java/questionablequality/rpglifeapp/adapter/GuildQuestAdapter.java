...
/**
 * Created by Tobi on 03-Nov-16.
 */

public class GuildQuestAdapter extends ArrayAdapter<Quest> {
    ...
    public GuildQuestAdapter(Context context, List<Quest> quests) {
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    api.saveGuildQuest(requestedQuest).get();
    ...
    public Filter getFilter() {
        if (filter == null) {
            filter = new GuildQuestAdapter.QuestFilter(quests);
        }
        return filter;
    }
